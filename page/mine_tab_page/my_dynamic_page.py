...
class MyDynamicPage(BasePage):

    def get_first_post_name(self):
        return self.find_element_and_value("post_item", "community_page_element")
    ...
    def click_and_input_post_content(self):
        self.find_element_and_sendKeys("input_word", "community_page_element", context="测试")
    ...
    def edit_comment(self):
        self.find_element_and_sendKeys("input_comment", "community_page_element", context="这一次", isClick=False)
    ...
    def get_my_dynamic_num_value(self):
        return self.find_element_and_value("dynamic_counts", "mine_page_element")

    def get_my_dynamic_index(self):
        return self.find_elements("my_dynamic_number_index", "mine_page_element")
